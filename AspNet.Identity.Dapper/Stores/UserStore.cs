...
namespace AspNet.Identity.Dapper
{
        ...
        where TUser : IdentityUser
    {
        ...
        public IdentityDbContextDapper Database { get; private set; }
        ...
        public UserStore()
        {
            new UserStore<TUser>(new IdentityDbContextDapper());
        }
        ...
        public UserStore(IdentityDbContextDapper database)
        {
            Database = database;
        ...
        public Task<TUser> FindByIdAsync(string userId)
        {
            ...
            TUser result = userTable.GetUserById(userId).Result;
            if(result != null)
            {
        ...
        public Task<TUser> FindAsync(UserLoginInfo login)
        {
            ...
            if(userId != null)
            {
                TUser user = userTable.GetUserById(userId).Result;
                if(user != null)
                {
        ...
        public Task AddToRoleAsync(TUser user, string roleName)
        {
            ...
            string roleId = roleTable.GetRoleId(roleName).Result;
        ...
        public Task<TUser> FindByEmailAsync(string email)
        {
           ...
           List<TUser> result = userTable.GetUserByEmail(email);
            if(result != null && result.Count == 1)
            {
                return Task.FromResult<TUser>(result[0]);
            }
